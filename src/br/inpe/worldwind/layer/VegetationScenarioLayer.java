...
public class VegetationScenarioLayer {
	...
	public static class VegetationScenarioApp extends JFrame {
		...
		private KinectApp kinectHandler;
		...
		private void initKinectHandler() {
			kinectHandler = new KinectApp(this);
		...
		public void addVegetationLayer() {
			veg2000 = shapefile.getRenderableLayer(
		...
		public KinectApp getKinectHandler() {
			return kinectHandler;
		}

		public void setKinectHandler(KinectApp kinectHandler) {

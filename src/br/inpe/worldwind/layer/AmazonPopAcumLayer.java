...
public class AmazonPopAcumLayer extends RenderableLayer {
	...
	public AnnotationLayer addAnnotations() {
		...
		ScreenAnnotation sa = new ScreenAnnotation(
				"Desmatamento da floresta amazônica e população no Pará, Brasil",
				new Point(470, 700));
		...
		ScreenAnnotation legendHeader = new ScreenAnnotation(
				"Desmatamento em %", new Point(930, 270));
		...
		ScreenAnnotation heightLegend = new ScreenAnnotation(
				"Altura representa o total de habitantes", new Point(920, 65));
	...
	public AnnotationLayer generalInformationLayer() {
		...
		if (year == "2002") {
			...
			factAnnotation
					.setText("Pará é o segundo maior estado do Brasil.");
		...
		if (year == "2003") {
			...
			factAnnotation
					.setText("Belém, capital do Pará, é a 11ª maior cidade do Brasil. ");
		}
		if (year == "2004") {
			...
			factAnnotation.setText("No Pará existem mais cabeças de gado ("
					+ f2.format(cattleInventory)
					+ ") do que pessoas na Holanda (~16.000.000).");
		...
		if (year == "2005") {
			...
			factAnnotation
					.setText("Belém foi fundada em 1616 pelos Portugueses.");
		...
		if (year == "2006") {
			...
			factAnnotation.setText("No Pará vivem "
					+ f2.format(cattleInventory)
					+ " cabeças de gado, o que representa "
					+ f.format(cattleInventory / population)
					+ " cabeças de gado por pessoa.");
		}
		if (year == "2007") {
			factAnnotation
			...
			factAnnotation
					.setText("Pará é um dos estados mais pobres do Brasil.");

		}
		if (year == "2008") {
			factAnnotation
					.setText("Die População Pará´s entspricht ungefähr der Bevölkerung der Schweiz auf "
			...
			factAnnotation
					.setText("A população do Pará representa aproximadamente a populaçao da Suíça com uma área "
							+ f.format(totalArea / 41285) + " vezes maior.");
		}

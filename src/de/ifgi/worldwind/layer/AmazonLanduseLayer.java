...
//            LatLon.fromDegrees(43.0, -120.0)
     ...
     //   curtain.getAttributes().setOutlineWidth(10);
       // curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis.next();
        addRenderable(exportAnnotation(new Position(posis.next(), 42000.0), "Inglaterra: "+unitedKingdomExport));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis2.next();
        addRenderable(exportAnnotation(new Position(posis2.next(), 42000.0), "Russia: "+russiaExport));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis4.next();
        addRenderable(exportAnnotation(new Position(posis4.next(), 42000.0), "Egito: "+egyptExport));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis5.next();
        addRenderable(exportAnnotation(new Position(posis5.next(), 42000.0), "Alemanha: "+exportGermany));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis6.next();
        addRenderable(exportAnnotation(new Position(posis6.next(), 42000.0), "EUA: "+exportUSA));
       //  attributesPlain.setInteriorOpacity(1);
...
public AnnotationLayer addAnnotations(){
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        //PT-BR
        ScreenAnnotation arcLegend = new ScreenAnnotation("Exportação de Carne Bovina Brasileira em Toneladas", new Point(920, 400));
    ...
    //    legend.getAttributes().setImageOffset(new Point(1, 1));
        ...
        //PT-BR
        ScreenAnnotation legend = new ScreenAnnotation("-utilizado para agricultura e cultivo de gado", new Point(920, 285));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
      ...
      //  backgroundAnnotation.getAttributes().setSize(new Dimension(300, 190));
        ...
        if(year == "2004"){
        	...
        	//PT-BR
        	factAnnotation.setText("As primeiras cabeças de gado foram trazidas por Colombo em 1493.");

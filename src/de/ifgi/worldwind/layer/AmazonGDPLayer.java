...
//	static ArrayList<Literal> pop9;
    ...
    private final static PowerOfTwoPaddedImage trees =
            PowerOfTwoPaddedImage.fromPath("images/baume2.jpg");
...
//         	 }
        	...
        	String[] splitStr = muniData.get(i).getCentroid().split(",");	
        	 ...
        	 if(muniData.get(i).getName().equals("SantarÃ©m") || muniData.get(i).getName().contains("BelÃ©m") || muniData.get(i).getName().contains("Altamira") || i == maxPos){
        	   GlobeAnnotation ga2 = new GlobeAnnotation(muniData.get(i).getName()+"\nPIB/Pessoa: "+f2.format(gdp*1000/pop*0.400125419)+"â‚¬",Position.fromDegrees(Double.parseDouble(splitStr[1]), Double.parseDouble(splitStr[0]),8000* gdp/pop), Font.decode("Arial-BOLD-12"));
...
//         System.out.println("min: "+minDefor +" max: "+maxDefor);
	...
	public AnnotationLayer addAnnotations(){
        ...
        //DE
        //ScreenAnnotation sa = new ScreenAnnotation("Bruttoinlandsprodukt und jÃ¤hrliche Abholzungsrate ParÃ¡, Brasilien", new Point(470, 700));
        
        //PT-BR
        ScreenAnnotation sa = new ScreenAnnotation("PIB e desmatamento anual no ParÃ¡, Brasil", new Point(470, 700));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        //DE
        //ScreenAnnotation legendHeader = new ScreenAnnotation("JÃ¤hrliche Abholzungsrate \n \n -hohe Abholzung \n\n\n \n \n \n\n   -geringe Abholzung", new Point(920, 270));
...
//        annotationLayer.addAnnotation(ifgiLogo);
        ...
        //DE
        //ScreenAnnotation heightLegend = new ScreenAnnotation("HÃ¶he entspricht dem Bruttoinlands- produkt pro Person", new Point(920,65));
...
//        generalAnnotationLayer.addAnnotation(gdpAnnotation);
        ...
        if(year == "2002"){
        	...
        	statAnnotation.setText("ParÃ¡ \n PopulaÃ§Ã£o: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÃ�rea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"kmÂ²\n PIB: "+f.format(averageGDP*0.400125419)+"â‚¬");
        }
        if(year == "2003"){
        ...
        if(year == "2004"){
        	factAnnotation.setText("O desmatamento anual de "+f.format(averageDefor*totalArea)+ "kmÂ² representa " +f.format(averageDefor*totalArea/2569.69) +" vezes a Ã¡rea de Saarland.");
        	statAnnotation.setText("ParÃ¡ \n PopulaÃ§Ã£o: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÃ�rea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"kmÂ²\n PIB: "+f.format(averageGDP*0.400125419)+"â‚¬");
        ...
        if(year == "2008"){
        	factAnnotation.setText("O Brasil utiliza 16000 kmÂ² ("+(f.format(16000/2569.69))+"x Saarland) para suprir a demanda de soja da Alemanha.");
        	statAnnotation.setText("ParÃ¡ \n PopulaÃ§Ã£o: " +f2.format((int)population) + "\n Desmatamento Anual: "+f.format(averageDefor*100) +"%\nÃ�rea deflorestada anualmente: "+f.format(averageDefor*totalArea) +"kmÂ²\n PIB: "+f.format(averageGDP*0.400125419)+"â‚¬");
...
////        if(year=="2006"){
////        	ScreenAnnotation statement2008Annotation = new ScreenAnnotation("\"Brasiliens Fleisch Exporte steigen um 14% jÃ¤hrlich\"", new Point(165, 380));
...
//        if(year == "2002"){
//        	factAnnotation.setText("2002");
//        	statAnnotation.setText("ParÃ¡ \n BevÃ¶lkerung: " +population + "\n Gesamte Abholzung: "+f.format(averageAcumDefor*100) +"%\n BevÃ¶lkerungsentwicklung: "+(population-populationLastYear));
//        }
//        if(year == "2003"){
//        	factAnnotation.setText("2003");
//        	statAnnotation.setText("ParÃ¡ \n BevÃ¶lkerung: " +population + "\n Gesamte Abholzung: "+f.format(averageAcumDefor*100) +"%\n BevÃ¶lkerungsentwicklung: "+(population-populationLastYear));

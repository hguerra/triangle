...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        //PT-BR
        addRenderable(exportAnnotation(route2.getReferencePosition(), "Exportação de Soja para China"));
       //  attributesPlain.setInteriorOpacity(1);
	...
	public AnnotationLayer addAnnotations(){
        ...
        //DE
        //ScreenAnnotation sa = new ScreenAnnotation("Gesamte- und jährliche Abholzung des Regenwaldes in Para, Brasilien", new Point(900, 1000));
        
        //PT-BR
        ScreenAnnotation sa = new ScreenAnnotation("Desmatamento anual e total da floresta amzônica no Pará, Brasil", new Point(900, 1000));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        //PT-BR
        ScreenAnnotation legendHeader = new ScreenAnnotation("Desmatamento anual da floresta amazônica em % (" + year +")", new Point(1750, 125));

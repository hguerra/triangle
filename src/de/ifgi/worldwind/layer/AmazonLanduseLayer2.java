...
public class AmazonLanduseLayer2 extends RenderableLayer {
	...
	public void drawPolygons() {
		...
		for (int i = 0; i < muniData.size(); i++) {
			...
			if (muniData.get(i).getName().equals("SantarÃ©m")
					|| muniData.get(i).getName().contains("BelÃ©m")
	...
	public void drawArc() {
		...
		addRenderable(exportAnnotation(new Position(posis.next(), 42000.0),
				"Inglaterra: " + f2.format(unitedKingdomExport)));
		...
		addRenderable(exportAnnotation(new Position(posis5.next(), 42000.0),
				"Alemanha: " + f2.format(exportGermany)));
	...
	public AnnotationLayer addAnnotations() {
		...
		ScreenAnnotation sa = new ScreenAnnotation(
				"Desmatamento e uso do solo no ParÃ¡ & ExportaÃ§Ã£o de carne Brasileira",
				new Point(470, 700));
		...
		ScreenAnnotation sa2 = new ScreenAnnotation("Ano " + year, new Point(
				125, 550));
		...
		ScreenAnnotation arcLegend = new ScreenAnnotation(
				"ExportaÃ§Ã£o de Carne Bovina Brasileira\n (toneladas)",
				new Point(920, 400));
		...
		ScreenAnnotation legendHeader = new ScreenAnnotation("Ã�rea Desmatada",
				new Point(920, 225));
		...
		ScreenAnnotation legend = new ScreenAnnotation(
				"-utilizado para agricultura e cultivo do gado", new Point(920,
						285));
		...
		ScreenAnnotation legend2 = new ScreenAnnotation(
				"-utilizado para agricultura", new Point(920, 225));
		...
		ScreenAnnotation heightLegend = new ScreenAnnotation(
				"Altura representa o desmatamento total em %", new Point(920,
						65));
	...
	public AnnotationLayer generalInformationLayer() {
		...
		if (year == "2003") {
			...
			statAnnotation.setText("ParÃ¡ \n Ã�rea: "
					+ f2.format((int) totalArea) + " kmÂ²\n Ã�rea desmatada: ~"
					+ f2.format((int) totalDeforestArea)
					+ " kmÂ²\n\n ExportaÃ§Ã£o de Carne Bovina: "
					+ f2.format((int) totalExport) + " Tonnen");
		}
		if (year == "2004") {

			factAnnotation
					.setText("Die ersten Rinder kamen 1493 mit Kolumbus nach SÃ¼damerika.");

			// PT-BR
			factAnnotation
					.setText("As primeiras cabeÃ§as de gado foram trazidas por Colobo em 1493.");
			...
			statAnnotation.setText("ParÃ¡ \n Ã�rea: "
					...
					+ f2.format((int) totalDeforestArea)
					+ " kmÂ²\n\n ExportaÃ§Ã£o de Carne Bovina: "
					+ f2.format((int) totalExport) + " toneladas");

		}
		if (year == "2005") {
			factAnnotation.setText("Im Jahr 2005 gab es "
					+ f2.format(cattleInventory) + " Rinder in ParÃ¡.");

			// PT-BR
			factAnnotation.setText("No ano de 2005 existiam "
					+ f2.format(cattleInventory)
					+ " cabeÃ§as de gado no ParÃ¡.");
		...
		if (year == "2006") {
			factAnnotation
					.setText("Brasiliens Fleisch Exporte stiegen um 14% jÃ¤hrlich zwischen 2002 und 2007.");

			// PT-BR
			factAnnotation
					.setText("\"Entre 2002 e 2007 a exportaÃ§Ã£o de carne brasileira cresceu 14% anualmente.\"");
		...
		if (year == "2007") {
			factAnnotation
					.setText("Brasilien ist der grÃ¶ÃŸte Fleischexporteur der Welt, mit 34% Anteil am globalen Markt.");

			// PT-BR
			factAnnotation
					.setText("\"O Brasil Ã© o maior exportador de carne do mundo, cobrindo 34% do mercado mundial.\"");
		...
		if (year == "2008") {
			factAnnotation
					.setText("37% der BeschÃ¤ftigten Brasiliens arbeiten in der Landwirtschaft.");

			// PT-BR
			factAnnotation
					.setText("\"37% dos empregos no Brasil sÃ£o relacionados Ã  agricultura.\"");

...
//	static ArrayList<Literal> pop9;
    ...
    private final static PowerOfTwoPaddedImage trees =
            PowerOfTwoPaddedImage.fromPath("images/baume3.jpg");
...
//        	 pgon2.setCapAttributes(capAttributesPlain); 
        	...
        	String[] splitStr = muniData.get(i).getCentroid().split(",");	
        	 ...
        	 if(muniData.get(i).getName().equals("SantarÃ©m") || muniData.get(i).getName().contains("BelÃ©m") || muniData.get(i).getName().contains("Altamira") || i == maxPos){
...
//        defaultAttributes.setDrawOffset(new Point(20, 40));
//		
//        ScreenAnnotation sa = new ScreenAnnotation("Gesamte- und jÃ¤hrliche Abholzung des Regenwaldes in ParÃ¡, Brazilien", new Point(900, 1000));
...
//        defaultAttributes2.setCornerRadius(0);
//        
//        ScreenAnnotation legendHeader = new ScreenAnnotation("JÃ¤hrliche Abholzung des Regenwaldes in % (" + year +")", new Point(1750, 125));
...
public AnnotationLayer addAnnotations(){
        ...
        //DE
        //ScreenAnnotation sa = new ScreenAnnotation("Abholzung und Bodennutzung in ParÃ¡ & Fleisch Exporte Brasiliens ", new Point(470, 700));
        
        //PT-BR
        ScreenAnnotation sa = new ScreenAnnotation("Desmatamento e uso do solo no ParÃ¡ & ExportaÃ§Ã£o de carne Brasileira", new Point(470, 700));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        //PT-BR
        ScreenAnnotation arcLegend = new ScreenAnnotation("ExportaÃ§Ã£o de Carne Bovina Brasileira\n (toneladas)", new Point(920, 400));
      ...
      //  arcLegend.getAttributes().setDefaults(defaultAttributes2);
       ...
       // legendHeader.getAttributes().
        ...
        ScreenAnnotation legendHeader = new ScreenAnnotation("Ã�rea Desmatada", new Point(920, 225));
      //  legendHeader.getAttributes().setDefaults(defaultAttributes2);
    ...
    //    legend.getAttributes().setImageOffset(new Point(1, 1));
        ...
        //DE
        //ScreenAnnotation legend = new ScreenAnnotation("-genutzt fÃ¼r Landwirtschaft und Viehzucht", new Point(920, 285));
    ...
    //    legend.getAttributes().setImageOffset(new Point(1, 1));
        ...
        //DE
        //ScreenAnnotation legend2 = new ScreenAnnotation("-genutzt fÃ¼r nicht landwirtschaftliche Zwecke", new Point(920, 225));
...
//        annotationLayer.addAnnotation(ifgiLogo);
        ...
        //DE
        //ScreenAnnotation heightLegend = new ScreenAnnotation("HÃ¶he entspricht der gesamten Abholzung in Prozent", new Point(920,65));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
      ...
      //  backgroundAnnotation.getAttributes().setSize(new Dimension(300, 190));
        ...
        if(year == "2002"){
        	...
        	statAnnotation.setText("ParÃ¡ \n FlÃ¤che: " +f2.format((int)totalArea) + " kmÂ²\n Abgeholzte FlÃ¤che: ~"+ f2.format((int)totalDeforestArea) +" kmÂ²\n\n Rindfleisch Export Brasiliens: "+ f2.format((int)totalExport) + " Tonnen");
        	
        	//PT-BR
        	statAnnotation.setText("ParÃ¡ \n Ã�rea: " +f2.format((int)totalArea) + " kmÂ²\n Ã�rea desmatada: ~"+ f2.format((int)totalDeforestArea) +" kmÂ²\n\n Rindfleisch Export Brasiliens: "+ f2.format((int)totalExport) + " Tonnen");
        }
        if(year == "2003"){
        	...
        	//PT-BR
        	statAnnotation.setText("ParÃ¡ \n Ã�rea: " +f2.format((int)totalArea) + " kmÂ²\n Ã�rea desmatada: ~"+ f2.format((int)totalDeforestArea) +" kmÂ²\n\n ExportaÃ§Ã£o de Carne Bovina: "+ f2.format((int)totalExport) + " Tonnen");
        }
        if(year == "2004"){
        	        	
        	
        	factAnnotation.setText("Die ersten Rinder kamen 1493 mit Kolumbus nach SÃ¼damerika.");
        	
        	//PT-BR
        	factAnnotation.setText("As primeiras cabeÃ§as de gado foram trazidas por Colobo em 1493.");

        	
        	statAnnotation.setText("ParÃ¡ \n FlÃ¤che: " +f2.format((int)totalArea) + " kmÂ²\n Abgeholzte FlÃ¤che: ~"+ f2.format((int)totalDeforestArea) +" kmÂ²\n\n Rindfleisch Export Brasiliens: "+ f2.format((int)totalExport) + " Tonnen");
        	
        	statAnnotation.setText("ParÃ¡ \n Ã�rea: " +f2.format((int)totalArea) + " kmÂ²\n Ã�rea desmatada: ~"+ f2.format((int)totalDeforestArea) +" kmÂ²\n\n ExportaÃ§Ã£o de Carne Bovina: "+ f2.format((int)totalExport) + " toneladas");
        	

        }
        if(year == "2005"){
        	factAnnotation.setText("Im Jahr 2005 gab es "+f2.format(cattleInventory) + " Rinder in ParÃ¡.");
        	
        	//PT-BR
        	factAnnotation.setText("No ano de 2005 existiam "+f2.format(cattleInventory) + " cabeÃ§as de gado no ParÃ¡.");
        ...
        if(year == "2006"){
        	factAnnotation.setText("Brasiliens Fleisch Exporte stiegen um 14% jÃ¤hrlich zwischen 2002 und 2007.");

        	//PT-BR
        	factAnnotation.setText("\"Entre 2002 e 2007 a exportaÃ§Ã£o de carne brasileira cresceu 14% anualmente.\"");
        ...
        if(year == "2007"){
        	factAnnotation.setText("Brasilien ist der grÃ¶ÃŸte Fleischexporteur der Welt, mit 34% Anteil am globalen Markt.");
        	
        	//PT-BR
        	factAnnotation.setText("\"O Brasil Ã© o maior exportador de carne do mundo, cobrindo 34% do mercado mundial.\"");
        ...
        if(year == "2008"){
        	factAnnotation.setText("37% der BeschÃ¤ftigten Brasiliens arbeiten in der Landwirtschaft.");
        	
        	//PT-BR
        	factAnnotation.setText("\"37% dos empregos no Brasil sÃ£o relacionados Ã  agricultura.\"");
